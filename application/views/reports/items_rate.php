...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = '<?php echo base_url() ?>index.php/Reports/items_rate?range='+range;
  });
  $("#selected_vendor").on('change', function(){
    var selected_vendor = encodeURI($(this).val());
    window.location = '<?php echo base_url() ?>index.php/Reports/items_rate?selected_vendor='+selected_vendor;
  });

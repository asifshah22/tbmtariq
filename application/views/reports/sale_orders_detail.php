    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        <div class="box">
          <div class="box-header">
            ...
            <div class="pull-right">
              <form method="POST" class="form-inline" id="adjustProductRateForm">
                ...
                <?php if(in_array('printSaleDetailsNonEmp', $user_permission)): ?>
                  <a href="<?php echo base_url() ?>index.php/Reports/print_sale_orders_detail<?php if(isset($_GET['range'])){ echo "?range=".$_GET['range']; } ?>" target="__blank" class="btn btn-success btn-sm btn-flat" id="print"><span class="glyphicon glyphicon-print"></span> Print</a>
                <?php endif; ?>
              </form>
            </div>
          </div>
              ...
              <tbody bgcolor="#eaeaea">
                ...
                <?php foreach ($result as $key => $value): ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        <span style="background-color: #ffffff">
                          <strong>Discount: <?php echo floatval($sale_order_data['discount']); ?></strong>
                        </span>
                      </p>
                      <p>
                        <span style="background-color: #ffffff">
                          <strong>Freight: <?php echo floatval($sale_order_data['loading_or_affair']); ?></strong>
                        </span>
                      </p>
                    </td>
                    <td>
                        ...
                        <tbody>
                          ...
                          <?php foreach($sale_items_data as $key => $value): ?>
                            ...
                            <tr>
                              ...
                              <td><?php echo floatval($value['product_price'] / $unit_value); ?></td>
                            </tr>
                          <?php endforeach; ?>
                        </tbody>
                    ...
                    <?php if( (in_array('viewSaleOrderNE', $user_permission)) || (in_array('updateSaleOrderNE', $user_permission)) ): ?>
                      <td>
                        <?php if( (in_array('viewSaleOrderNE', $user_permission)) ): ?>
                          <a href="<?php echo base_url() ?>index.php/Product/view_sale_order_items/<?php echo $sale_order_data['id'] ?>"><i class="fa fa-eye"></i>
                          </a>
                        <?php endif; ?>
                        <?php if( (in_array('updateSaleOrderNE', $user_permission)) ): ?>
                          <a href="<?php echo base_url() ?>index.php/Product/update_sale_order/<?php echo $sale_order_data['id'] ?>"><i class="fa fa-edit"></i>
                          </a>
                        <?php endif; ?>
          ...
          <div class="row">
            <div class="col-md-4">
              <b>Total Net Amount: </b><?php echo floatval($sum_net_amounts); ?>
            </div>
            <div class="col-md-3">
              <b>Total Received Amount: </b><?php echo floatval($sum_paid_amounts); ?>
            </div>
            <div class="col-md-5">
              <b>Total Remaining Amount: </b><?php echo floatval($sum_remaining_amounts); ?>
            </div>
          </div>
          </div>
          <!-- /.box-body -->
...
$(document).ready(function() {
  ...
  $("#saleOrdersDetailNav").addClass('active');

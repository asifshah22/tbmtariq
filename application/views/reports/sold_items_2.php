            ...
            <div class="pull-right">
              <form method="POST" class="form-inline" id="payForm">
                ...
                <?php if(in_array('printReports', $user_permission)): ?>
                  <a href="<?php echo base_url() ?>index.php/Reports/print_sold_items_2<?php if(isset($_GET['range'])){ echo "?range=".$_GET['range']; } ?>" target="__blank" class="btn btn-success btn-sm btn-flat" id="print"><span class="glyphicon glyphicon-print"></span> Print</a>
                <?php endif; ?>
              </form>
            </div>
          </div>
              ...
              <tbody>
                ...
                <?php foreach ($result as $key => $value): ?>
                  <?php
                    ...
                    $department_data = $this->Model_department->getCustomerDeparment($value['customer_id']);
                    $category_name = '';
...
$(document).ready(function() {
  ...
  $("#itemsSoldNav-2").addClass('active');
...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = '<?php echo base_url() ?>index.php/Reports/sold_items_2?range='+range;
  });

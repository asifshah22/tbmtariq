            ...
            <div class="pull-right">
              <form method="POST" class="form-inline" id="payForm">
                ...
                <?php if(in_array('printReports', $user_permission)): ?>
                  <a href="<?php echo base_url() ?>index.php/Reports/print_purchased_items<?php if(isset($_GET['range'])){ echo "?range=".$_GET['range']; } ?>" target="__blank" class="btn btn-success btn-sm btn-flat" id="print"><span class="glyphicon glyphicon-print"></span> Print</a>
                <?php endif; ?>
              </form>
            </div>
          </div>
              ...
              <tbody>
                ...
                <?php foreach ($result as $key => $value): ?>
                  ...
                  <tr>
                    ...
                    <td><?php echo floatval(($value['qty'] * $unit_data_values['unit_value']) - $return_items); ?></td>
                  </tr>
                  <?php $sum_total_items += ($value['qty'] * $unit_data_values['unit_value']) - $return_items; ?>
...
$(document).ready(function() {
  ...
  $("#itemsPurchasedNav").addClass('active');
...
$(function(){
  ...
  $("#reservation").on('change', function(){
    ...
    window.location = '<?php echo base_url() ?>index.php/Reports/purchased_items?range='+range;
  });

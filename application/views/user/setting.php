            ...
            <form role="form" action="<?php base_url('users/setting') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input disabled="true" type="text" class="form-control" id="phone" name="phone" placeholder="Phone" value="<?php echo $phones ?>" autocomplete="off">
                </div>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url() ?>index.php/User/manage_users" class="btn btn-warning">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->

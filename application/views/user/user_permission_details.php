...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      User
      <small>User Permission Details</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">User Permission Details</li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('printUserGroup', $user_permission)): ?>  
          <a title="Print User Permissions" target="__blank" href="<?php echo base_url() ?>index.php/User/print_user_permission_details/<?php echo $this->uri->segment(3) ?>" class="btn btn-info" id="print">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">User Permission Details</h3>
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <input readonly type="text" class="form-control" name="username" value="<?php echo $UserPermissions['username']; ?>">
            </div>
            <div class="form-group">
              <label for="fullname">Full Name: </label>
              <input readonly type="text" class="form-control" name="fullname" value="<?php echo $UserPermissions['firstname'] .' '.$UserPermissions['lastname']; ?>">
            </div>
            <div class="form-group">
              <label for="permission">Permissions</label>
              <?php $serialize_permission = unserialize($UserPermissions['permission']); ?>

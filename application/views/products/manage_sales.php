  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php endif; ?>
        <?php if(in_array('createSaleOrderNE', $user_permission)): ?>
          <a title="Create New Sale" href="<?php echo base_url() ?>index.php/Product/create_sale_order" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i></a>
        <?php endif; ?>
        <?php if(in_array('printSaleOrderNE', $user_permission)): ?>
          <a title="Print Sales Order" target="__blank" href="<?php base_url() ?>print_sales_order" class="btn btn-info" id="print">
            <span class="glyphicon glyphicon-print"></span>
          </a>
        <?php endif; ?>
        <?php if( ( in_array('createSaleOrderNE', $user_permission) ) || ( in_array('printSaleOrderNE', $user_permission) ) ): ?>
          <br /> <br />
        <?php endif; ?>
          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-hover">
              ...
              <tr>
                ...
                <th style="color:#3c8dbc">Net Amount</th>
                <th style="color:#3c8dbc">Received</th>
                <th style="color:#3c8dbc">Remaining</th>
                <?php if( (in_array('updateSaleOrderNE', $user_permission)) || (in_array('deleteSaleOrderNE', $user_permission)) || (in_array('printSaleOrderNE', $user_permission)) ): ?>
                  <th width="7%"></th>
                <?php endif; ?>
              </tr>
              </thead>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'index.php/Product/fetchSaleOrders',
    'order': [],

      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Update Company Sale</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php echo base_url() ?>index.php/Product/update_company_sale_order/<?php echo $this->uri->segment(3)?>" method="post" class="form-horizontal">
              <div class="box-body">

                <?php echo validation_errors(); ?>

                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Date: <?php echo $date ?></label>
                </div>
                <div class="form-group">
                  <label for="gross_amount" class="col-sm-12 control-label">Time: <?php echo $time ?></label>
                </div>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input required="true" disabled type="text" class="form-control" id="customer_name" name="customer_name" placeholder="Full Name" autocomplete="off" value="<?php if($customer_data){ echo $customer_data['full_name'];} ?>"/>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="customer_deparment" class="col-sm-4 control-label">Department</label>
                    <div class="col-sm-8">
                      <input required="true" disabled type="text" class="form-control" id="customer_deparment" name="customer_deparment" placeholder="Department" autocomplete="off" value="<?php if($department_data){ echo $department_data['department_name'];} ?>"/>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" disabled required="true" class="form-control" id="customer_address" name="customer_address" placeholder="Customer Address" autocomplete="off" value="<?php if($customer_data){echo $customer_data['address'];} ?>">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" disabled required="true" class="form-control" id="customer_contact" name="customer_contact" placeholder="Contact Info" autocomplete="off" value="<?php if($customer_data){echo $customer_data['phone_number'];} ?>">
                    </div>
                  </div>
                </div>
                    ...
                    <div class="col-sm-8">
                      <select required name="trusted_customer" id="trusted_customer" onchange="getCustomerData()" class="form-control">
                        ...
                        <?php foreach ($customers as $k => $v): ?>
                          <?php if($customer_data && $department_data): ?>
                                ...
                                <?php 
                                  ...
                                  if($v['id'] == $value['customer_id']):?>
                                    <?php 
                                      ...
                                      $deparment_name = $this->Model_department->getDepartmentData($deparment_id)['department_name'];
                                    ?>
                                    <?php if($customer_data['id'] == $v['id'] && $department_data['id'] == $value['department_table_id']): ?>
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                    <tr>
                      ...
                      <th style="width:20%" class="required-field">Qty</th>
                   ...
                   <tbody>
                     <?php if(isset($sale_items_data)): ?>
                      ...
                      <tr id="row_<?php echo $x; ?>">
                        ...
                        <td>
                          <select class="form-control" data-row-id="<?php echo $x; ?>" id="unit_<?php echo $x; ?>" name="unit[]" >
                        ...
                        <td>
                          ...
                          ?>
                          <input type="number" autocomplete="off" min="0.1" step="any" name="qty[]" id="qty_<?php echo $x; ?>" class="form-control noscroll" onkeyup="getTotal(<?php echo $x; ?>)" value="<?php echo ($val['qty'] / $unit_value); ?>">
                        </td>
                        <td>
                ...
                <div class="col-md-4">
                  <textarea style="resize:none" placeholder="Remarks" rows="5" name="remarks" id="remarks" class="form-control" /><?php echo $sale_order_data['remarks']; ?></textarea>
                </div>
            ...
            success:function(response) {
              ...
              var html = '<tr id="row_'+row_id+'">'+
                  ...
                  html += '</select>'+
                      ...
                      '<td>'+ 
                      '<select class="form-control" data-row-id="'+row_id+'" id="unit_'+row_id+'" name="unit[]" disabled>'+
                          '<option value="">Select Unit</option>';
                  ...
                  html += '</select>'+
                        ...
                        '<td><input type="text" disabled name="s_qty_value[]" id="s_qty_value_'+row_id+'" class="form-control"></td>'+

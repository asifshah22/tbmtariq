...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Report
      <small>Factory Stock - By Item Name</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Factory Stock - By Item Name</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">    
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Factory Stock - By Item Name</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-hover">
              ...
              <tr>
                <th width="10%">#</th>
                <th width="40%" style="color:#3c8dbc">Item</th>
                <th width="25%" style="color:#3c8dbc">Unit</th>
                <th width="25%" style="color:#3c8dbc">
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'index.php/Product/fetchFactoryStockByItem',
    'order': [2, "asc"],

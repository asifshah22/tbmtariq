    ...
    */
        ...
        else
        {
            ...
            if ($this->form_validation->run() == TRUE) 
            {
                ...
                else
                {
                    ...
                    if($count > 0){
                        foreach ($productArrayNew as $key => $value) {
                            $productCategoryData = $this->Model_products->getProductCategory($product_id = $value['id'], $p_category_id);
                            if(!empty($productCategoryData)){
                                // exist product with category
                                $response['success'] = false;
                                $response['messages'] = 'This Item already exist. Try different combination';
    ...
    public function print_stock_items()
    {
        ...
        else
        {
            ...
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>Tariq Body Maker | Stock Items Print</title>
...
public function fetchUnitsData()
{
    ...
    public function print_units()
    {
        ...
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>Tariq Body Maker | Units Print</title>
        <!-- Tell the browser to be responsive to screen width -->
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <!-- Bootstrap 3.3.7 -->
        <link rel="stylesheet" href="'.base_url('assets/bower_components/bootstrap/dist/css/bootstrap.min.css').'">
...
public function update_sale_order($order_id)
{
    ...
    public function print_sales_order()
    {
        ...
        else
        {
            ...
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>Tariq Body Maker | Sale Orders Print</title>
            <!-- Tell the browser to be responsive to screen width -->
            <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
            <!-- Bootstrap 3.3.7 -->
            <link rel="stylesheet" href="'.base_url('assets/bower_components/bootstrap/dist/css/bootstrap.min.css').'">
...
public function print_sale_invoice($order_id)
{
    ...
    else
    {
        ...
        if(!empty($data['sale_order_data'])){
            ...
            <div class="col-xs-12">
            <div class="invoice-title text-center">
            <h3>Tariq Body Maker</h3><h6 class="pull-right">'.$sale_order_data['bill_no'].'</h6>
            </div>
            <hr>
            <div class="row">
            <div class="col-xs-6">
...
public function create_company_sale_order()
{
    ...
    public function print_company_sales_order()
    {
        ...
        else
        {
            ...
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>Tariq Body Maker | Company Sale Orders Print</title>
            <!-- Tell the browser to be responsive to screen width -->
            <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
            <!-- Bootstrap 3.3.7 -->
            <link rel="stylesheet" href="'.base_url('assets/bower_components/bootstrap/dist/css/bootstrap.min.css').'">
    ...
    public function print_company_sale_invoice($order_id)
    {
        ...
        else
        {
            ...
            if(!empty($data['sale_order_data']))
            {
                ...
                <div class="col-xs-12">
                <div class="invoice-title text-center">
                <h3>Tariq Body Maker</h3><h4 class="pull-right">'.$sale_order_data['bill_no'].'</h4>
                </div>
                <hr>
                <div class="row">
                <div class="col-xs-6">
    ...
    public function print_sale_prices()
    {
        ...
        else
        {
            ...
            <meta charset="utf-8">
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
            <title>Tariq Body Maker | Sale Prices Print</title>
            <!-- Tell the browser to be responsive to screen width -->
            <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
            <!-- Bootstrap 3.3.7 -->
            <link rel="stylesheet" href="'.base_url('assets/bower_components/bootstrap/dist/css/bootstrap.min.css').'">
